...
```shell
docker run -dP -v /my_apps:/srv/projects accetto/xubuntu-vnc-angular

# or using the newer syntax

docker run -dP --mount source=/my_apps,target=/srv/projects accetto/xubuntu-vnc-angular
```
...
[badge-VERSION_STICKER_LATEST]: https://badgen.net/badge/version%20sticker/ubuntu18.04.5-node14.15.5-npm6.14.11-code1.53.2-tsc4.1.5-angular11.2.1/blue

[badge-github-commit-latest]: https://images.microbadger.com/badges/commit/accetto/xubuntu-vnc-angular.svg

<!-- chromium tag badges -->

[badge-VERSION_STICKER_CHROMIUM]: https://badgen.net/badge/version%20sticker/ubuntu18.04.5-node14.15.5-npm6.14.11-code1.53.2-tsc4.1.5-angular11.2.1-chromium87.0.4280.66/blue

[badge-github-commit-chromium]: https://images.microbadger.com/badges/commit/accetto/xubuntu-vnc-angular:chromium.svg

<!-- firefox tag badges -->

[badge-VERSION_STICKER_FIREFOX]: https://badgen.net/badge/version%20sticker/ubuntu18.04.5-node14.15.5-npm6.14.11-code1.53.2-tsc4.1.5-angular11.2.1-firefox85.0.1/blue
